...
const dummyNotifications: Notification[] = [
  {
    ...
    message:
      "Your Swift (MH12AB1234) service is currently in progress. Estimated completion: 4:00 PM",
    type: "info",
    timestamp: "2024-01-20 11:30",
    read: false,
    whatsappSent: true,
  },
  {
    ...
    message:
      "Your Creta (MH12CD5678) is ready for delivery. Please confirm pickup time.",
    type: "success",
    timestamp: "2024-01-18 18:00",
    read: false,
    whatsappSent: true,
  },
  {
    ...
    message:
      "Your Baleno (MH12EF9012) service has been completed successfully. Thank you for choosing us!",
    type: "success",
    timestamp: "2024-01-15 14:30",
    read: true,
    whatsappSent: true,
